...
#### 1. 创建服务
   ...
   ![创建服务](/images/posts/让百度索引你的github的博客/3.pic_hd.jpg)

#### 2. 配置回源
   
   ![配置回源](/images/posts/让百度索引你的github的博客/5.pic_hd.jpg)

#### 3. 绑定域名
完成上面的操作后，又拍云会自动分配一个域名给我。此时，我们就需要绑定自己的域名。添加需要绑定的域名：

   ![绑定域名](/images/posts/让百度索引你的github的博客/5.pic.jpg)
...
添加完域名绑定后，此时我们就只需要配置dns解析到又拍云了。我使用的是阿里云的域名系统，下图就是我设置的域名解析配置。
   ...
   ![配置解析](/images/posts/让百度索引你的github的博客/6.pic_hd.jpg)
...
最关键的问题是，我们要验证百度是否能正常的抓取我们的博客？ 我们使用百度站长的测试工具来测试一下：
  ...
  ![抓取诊断](/images/posts/让百度索引你的github的博客/7.pic_hd.jpg)
...
![配置解析](/images/posts/让百度索引你的github的博客/10.pic_hd.jpg)
...
![配置Webhook](/images/posts/让百度索引你的github的博客/13.pic.jpg)
