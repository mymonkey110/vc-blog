    ...
    <div className="flex flex-1 justify-center px-40 py-5">
      <div className="flex max-w-[960px] flex-1 flex-col">
          ...
          <div className="flex w-full flex-col gap-4 items-center">
            <div className="flex gap-4 flex-col items-center">
              ...
              <div className="flex flex-col items-center justify-center justify-center">
                ...
                <p className="text-lg font-body text-secondary-text text-center">
                  技术爱好者，热爱分享
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-[40px_1fr] gap-x-2 px-4">
          ...
          <div className="flex flex-1 flex-col py-3">
            <p className="text-base font-medium text-primary-text leading-normal">
              加入IoT创业公司
            </p>
            <p className="text-base font-body text-secondary-text leading-normal">
              2015.8 - 2016.8
        ...
        <div className="p-4 grid grid-cols-[20%_1fr] gap-x-6">
          ...
          <div className="col-span-2 grid grid-cols-subgrid border-t border-border py-5">
            ...
            <p className="text-sm font-ui text-primary-text leading-normal">
              github.com/mymonkey110
            </p>
          </div>
          <div className="col-span-2 grid grid-cols-subgrid border-t border-border py-5">
          ...
          <div className="mt-10 border-t border-border pt-5 col-span-full">
            <Comment title="about" />
          </div>
        </div>
      </div>
