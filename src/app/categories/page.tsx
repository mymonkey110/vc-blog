  ...
  return (
    <div className="flex flex-1 justify-center px-4 sm:px-8 lg:px-40 py-5">
      <div className="flex max-w-[960px] flex-1 flex-col">
        <div className="flex flex-wrap justify-between gap-3 mb-6 sm:mb-8 px-2 sm:px-0">
          ...
          {categories.map((category) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-4 bg-surface-light dark:bg-surface-dark px-3 sm:px-4 min-h-12 sm:min-h-14 rounded-lg transition-all hover:bg-surface-subtle-light dark:hover:bg-surface-subtle-dark hover:shadow-sm"
              >
                <p className="text-base sm:text-lg font-medium leading-normal font-heading">
                  {catName}
